...
- `research_tool`：當用戶的問題需要多步驟的資料蒐集、網路搜尋、彙整與產生完整研究報告時，請優先使用這個工具。
  - 例如：「請幫我寫一份關於AI倫理的詳細研究報告」、「請規劃並整理台灣能源政策的現況與未來發展」、「請自動搜尋並彙整2024年全球半導體產業趨勢」。
  - 當用戶明確要求「自動規劃、搜尋、整合、產生報告」或問題內容明顯需要多步驟查詢與彙整時，請使用 research_tool。
  - 若不確定是否需要 research_tool，可先詢問用戶需求或判斷問題複雜度。
