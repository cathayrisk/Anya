...
prompt_template = PromptTemplate(
    ...
    template=(
        "Please improve the formatting of the following transcription text while preserving the original wording and information. "
        "The improvements should include:\n"
        "- Adding appropriate headings and subheadings to organize the content, using a consistent style.\n"
        "- Highlighting key terms or important concepts using bold or italics for emphasis.\n"
        "- Checking and correcting any grammatical or spelling errors.\n\n"
        "Please list the text sentence by sentence without changing the original sentences or their order. "
        "Present the text in its original language. If the text is in Chinese, please use Traditional Chinese, not Simplified Chinese. Here is the text:\n\n{text}"
    )
)
