...
prompt_template = PromptTemplate(
    ...
    template=(
        ...
        "- **Identify and label the speaker for each sentence.**\n"
        "    - If the speaker is explicitly mentioned, use the given name or role (e.g., 主持人、張經理、王小姐)。\n"
        "    - If not, infer and assign generic labels such as 說話者1、說話者2 based on context and speaking turns.\n"
        ...
        "6. Each sentence should be preceded by the speaker label, e.g., 「主持人：」、「說話者1：」。\n"
        "7. Preserve the original language and style.\n\n"
        "# Reasoning Steps\n"
        ...
        "# Example\n"
        "## Input\n"
        "text: 主持人大家好，歡迎參加今天的會議。今天的主題是產品開發進度。王經理我們目前的進度如何？王經理目前已經完成第一階段，預計下週進入第二階段。主持人有遇到什麼困難嗎？王經理主要是資源分配上有些挑戰。主持人謝謝王經理的說明。請問其他同仁有補充嗎？李小姐我想補充一下，測試部門也會配合時程調整。主持人感謝大家的參與，會議到此結束。\n\n"
        "## Output\n"
        "**主題：產品開發進度會議**\n\n"
        "*引言*\n"
        "主持人：大家好，歡迎參加今天的會議。\n"
        ...
        "*進度報告*\n"
        "主持人：王經理，我們目前的進度如何？\n"
        "王經理：目前已經完成第一階段，預計下週進入第二階段。\n"
        "主持人：有遇到什麼困難嗎？\n"
        "王經理：主要是**資源分配**上有些挑戰。\n\n"
        "*討論與補充*\n"
        "主持人：謝謝王經理的說明。請問其他同仁有補充嗎？\n"
        "李小姐：我想補充一下，**測試部門**也會配合時程調整。\n\n"
        "*結語*\n"
        "主持人：感謝大家的參與，會議到此結束。\n"
        "\n"
        "# Final Instructions\n"
